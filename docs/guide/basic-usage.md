...
'modules' => [
    ...
    'admin' => [
        ...
        'controllerMap' => [
            'assignment' => [
                'class' => 'barilee\yii2\auth\rbac\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `barilee\yii2\auth\rbac\components\AccessControl`:
